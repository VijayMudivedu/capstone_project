...
master_df_final <- data.frame(Hospital.overall.rating = master_df$Hospital.overall.rating,master_df_imputed_final)
str(master_df_final)
# Sampling
...
zz <- as.character(master_df_final$Hospital.overall.rating)

master_df_final[master_df_final$Hospital.overall.rating != "Missing",]


master_df_final <- master_df_no_na_final
